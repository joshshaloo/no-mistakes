...
- Bitbucket has neither both direct REST credential variables in the daemon environment nor an installed `bkt` v0.30.0+ with an authenticated Cloud Keychain context
