...
var migrationStatements = []string{
	...
	// The exact head a successfully completed Test step validated. Nullable and
	// never backfilled: a skipped, failed, or approved-with-failures Test step
	// leaves no green evidence, and mutable head_sha cannot prove one existed.
	`ALTER TABLE runs ADD COLUMN test_verified_head_sha TEXT`,
